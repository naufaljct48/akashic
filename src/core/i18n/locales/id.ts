export const id = {
  ...
  spotlight: {
    ...
    noResults: (q: string) =>
      `Tidak ada hasil untuk "${q}". Tekan Enter di tab Discovery untuk pencarian AI.`,
    nav: 'Navigasi',
    select: 'Pilih',
    close: 'Tutup',
    open: 'Buka',
  ...
  bookmarks: {
    ...
    emptyDesc:
      'Tandai komik favorit Anda dari tab Discovery atau Katalog untuk disimpan di library offline lokal ini.',
  ...
  about: {
    ...
    p3Title: 'Reading Tracker Offline & Privacy First',
